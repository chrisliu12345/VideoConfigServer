...
public class AuthorityController {
        ...
        for (int i = 0; i < authorityList.size(); i++) {
          ...
          /*  List<Resource> lists = new ArrayList<>();*/
            ...
            for (int j = 0; j < authorityList1.size(); j++) {
                ...
                resource.setId(String.valueOf(authorityList1.get(j).getResourceId()));
    ...
    public String add(@RequestBody Authority authority) {
        ...
        if (authority.getSelected() != null) {
            for (int i = 0; i < authority.getSelected().size(); i++) {
                ...
                resourceAuthority.setResourceId(Integer.parseInt(authority.getSelected().get(i)));
    ...
    public void update(@RequestBody Authority authority) {
        System.out.println("我是更新权限的设置"+authority.getSelected());
        if (authority.getSelected() == null ||authority.getSelected().size()<=0) {
            ...
            if (authority.getSelected() != null) {
                for (int i = 0; i < authority.getSelected().size(); i++) {
                    ...
                    resourceAuthority1.setResourceId(Integer.parseInt(authority.getSelected().get(i)));
